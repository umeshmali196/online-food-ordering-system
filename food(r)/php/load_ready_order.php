...
$sql = "SELECT * FROM tbl_order where order_status='ontheway' and r_id=$resid ORDER BY o_id ASC LIMIT $start_from, $limit";
...
<div class="card ml-2 box-shadow" style="width: 100%">
  <div class="card-body p-0  bg-blue">
    <span class="px-4 py-2 text-light rounded-0 font-weight-bolder text-uppercase">on the way</span>
  ...
  <div class="card-footer p-2 bg-transparent">
    <button class="btnshow float-right rounded-circle  border-0 " onclick="showreadyorder(<?php echo $row['o_id']; ?>)"><i
